...
public:
  MethodCallBaton(Java* java, jobject method, jarray args, Nan::Callback& callback);
...
public:
  InstanceMethodCallBaton(Java* java, JavaObject* obj, jobject method, jarray args, Nan::Callback& callback);
...
public:
  NewInstanceBaton(Java* java, jclass clazz, jobject method, jarray args, Nan::Callback& callback);
...
public:
  StaticMethodCallBaton(Java* java, jclass clazz, jobject method, jarray args, Nan::Callback& callback);
